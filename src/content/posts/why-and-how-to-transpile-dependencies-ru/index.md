---
title: Почему и как нужно транспилировать зависимости
description: Руководство по транспиляции кода зависимостей для обеспечения совместимости с современными и старыми браузерами.
date: 2022-02-17
cover: ./cover.png
tags:
  - transpilation
