---
title: 'How to setup Conventional Commits in JavaScript project: 2026 edition'
description: An updated complete guide to setting up automated release pipeline with Conventional Commits in JavaScript projects - now with AI agent skills.
date: 2026-07-14
tags:
  - git
  - automation
...
![Commits History](../how-to-setup-conventional-commits-in-javascript-project/commits.png)
...
![Changelog Example](../how-to-setup-conventional-commits-in-javascript-project/changelog.png)
...
If your team writes commits with an AI coding agent, the conventional-changelog project ships a universal [agent skill](https://conventional-changelog.js.org/getting-started/agent-skills/), `conventional-commit-message`, that teaches the agent to produce correct Conventional Commit messages - choosing the type and scope by release impact, flagging breaking changes, and validating against your Commitlint config when it is available.
...
![Simple Release Action Pull Request Example](../how-to-setup-conventional-commits-in-javascript-project/pr.png)

When the pull request is merged, it will automatically release the project.

![Simple Release Action Release Example](../how-to-setup-conventional-commits-in-javascript-project/release.png)
